            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                      ...
                      <hr>
                      <a style="float:right" href="{{ route('dashboard.accounts') }}">View Admins</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($admins as $admin)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.restore-account', $admin->id) }}" class="btn btn-primary">Restore</a>
                                    </td>
                                </tr>
                            @endforeach
                            @else
