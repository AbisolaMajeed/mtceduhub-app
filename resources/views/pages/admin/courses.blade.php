            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                      ...
                      <span>This captures the list courses</span>
                      <hr>
                      <a style="float:right" href="{{ route('dashboard.archived-courses') }}">View Archived Courses</a>
                      <a href="{{ route('dashboard.add-course') }}">Add new course</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                          ...
                          @if ($courses->count() > 0)
                            @foreach ($courses as $course)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.archive-course', $course->id) }}" class="btn btn-danger">Archive</a>
                                    </td>
                                </tr>
                            @endforeach
                            @else
